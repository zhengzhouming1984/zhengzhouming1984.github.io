  ...
  <section class="section-container pt-32 md:pt-40 pb-20">
    <div class="space-y-6">
      <h1 class="text-4xl md:text-5xl font-bold tracking-tight">
        你好，我是 <span class="text-brand-400">{{ name }}</span>
      </h1>
...
const socials = [
  { label: 'GitHub', href: 'https://github.com/zhengzhouming1984', icon: IconGitHub },
  { label: '邮箱', href: '#contact', icon: IconMail, copy: '94711123@qq.com' },
